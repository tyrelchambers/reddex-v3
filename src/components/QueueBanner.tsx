...
const QueueBanner = ({ openQueue }: Props) => {
  ...
  return (
    <div className="sticky top-20 my-6 flex flex-col items-center justify-between overflow-hidden rounded-xl bg-accent text-white shadow-xl md:flex-row lg:top-2">
